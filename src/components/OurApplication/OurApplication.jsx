...
const OurApplication = () => {
 ...
 // Внутри функционального компонента
    ...
    return (
        <SectionLayuot props={{ display: { base: 'none', xxsm: 'flex' }, mt: '150px', pl: { base: '30px', desk: '0px!important' }, id: 'application' }}>
            <Flex w={{ base: '100%', mini: '100%', sm: '100%', lg: '90%' }} justifyContent={{ base: 'center', desk: 'end' }} mb={{ base: '80px', desk: '0px' }}>
                ...
                <Flex flexDir={{ base: 'column' }} gap={{ base: '30px', xl: '90px' }} w={{ base: '100%', xlg: '60%', desk: '45%' }} >
                    <Flex w='100%' justifyContent={'space-between'} alignItems={'flex-end'}>
                        ...
                        >
                            ...
                            <Text as={'p'} color={'#2E3083'} fontSize={'16px'} fontWeight={800} lineHeight={'24px'} textAlign={'left'} dangerouslySetInnerHTML={{ __html: t('ourApplicationDesc') }} />

                        </Box>
                        <Image w={{ base: '174px' }} h={{ base: '174px' }} src={'/qrcode.png'} alt={'ourApplication2'} />

                    </Flex>
                    <Flex w='100%' justifyContent={'space-around'} >

                        <Image w={{ base: '236px' }} h={{ base: '74px' }} src={'/appstore.png'} alt={'ourApplication3'} />
                        <Image w={{ base: '236px' }} h={{ base: '74px' }} src={'/googleplay.png'} alt={'ourApplication4'} />
                    </Flex>
