 ...
 // Внутри функционального компонента
    ...
    return (
        ...
        <SectionLayuot>
            ...
            <Grid
                templateColumns={{ base: 'repeat(1, 1fr)', md: 'repeat(2, 1fr)', desk: 'repeat(4, 1fr)' }}
                gap={{ base: '24px', md: '20px', desk: "5px" }}
                w={{ base: '100%',xlg: '95%' }}
                justifyItems={{ base: 'center', md: 'end', desk: 'center' }}
                alignItems={'start'}
            >
                <GridItem as={'div'} display={{ base: 'flex' }} flexDir={'column'} alignItems={'center'} px={'30px'} w={{ base: "269px", sm: '336px' }} bgImage={{ base: 'none', md: '/hero_backgr_1.png' }} bgRepeat={'no-repeat'} bgPosition={'center'} >
                    ...
                    <Text as={'p'} fontSize={{ base: '11px', md: '16px' }} fontWeight={400} lineHeight={{ base: '11px', md: '28px' }} textAlign={{ base: 'center', md: 'left' }} color={'#444444'}>{t('supportDiscription')}</Text>
                </GridItem>
                <GridItem as={'div'} display={{ base: 'flex' }} justifySelf={{ base: 'center', md: 'start', desk: 'center' }} flexDir={'column'} alignItems={'center'} justifyContent={'flex-start'} px={'30px'} w={{ base: "269px", sm: '336px' }} bgImage={{ base: 'none', md: '/hero_backgr_2.png' }} bgRepeat={'no-repeat'} bgPosition={'center'} >
                    ...
                    <Text as={'p'} fontSize={{ base: '11px', md: '16px' }} fontWeight={400} lineHeight={{ base: '11px', md: '28px' }} textAlign={{ base: 'center', md: 'left' }} color={'#444444'}>{t('transparencyDiscription')}</Text>
                </GridItem>
                <GridItem as={'div'} display={{ base: 'flex' }} flexDir={'column'} alignItems={'center'} px={'30px'} w={{ base: "269px", sm: '336px' }} bgImage={{ base: 'none', md: '/hero_backgr_1.png' }} bgRepeat={'no-repeat'} bgPosition={'center'} >
                    ...
                    <Text as={'p'} fontSize={{ base: '11px', md: '16px' }} fontWeight={400} lineHeight={{ base: '11px', md: '28px' }} textAlign={{ base: 'center', md: 'left' }} color={'#444444'}> {t('peaceOfMindDiscription')}</Text>
                </GridItem>
                <GridItem as={'div'} display={{ base: 'flex' }} justifySelf={{ base: 'center', md: 'start', desk: 'center' }} flexDir={'column'} alignItems={'center'} px={'30px'} w={{ base: "269px", sm: '336px' }} bgImage={{ base: 'none', md: '/hero_backgr_2.png' }} bgRepeat={'no-repeat'} bgPosition={'center'} >
                    ...
                    <Text as={'p'} fontSize={{ base: '11px', md: '16px' }} fontWeight={400} lineHeight={{ base: '11px', md: '28px' }} textAlign={{ base: 'center', md: 'left' }} color={'#444444'}>{t('sustainabilityDiscription')}</Text>
                </GridItem>
            </Grid>
        </SectionLayuot>
    );
