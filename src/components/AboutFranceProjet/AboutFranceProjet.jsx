...
const AboutFranceProjet = () => {
    ...
    return (
        <SectionLayuot props={{display: {base: 'none', xxsm: 'flex'}}}>
            <Box w={{ base: '100%', mini: '100%', sm: '100%', lg: '90%' }}>
                ...
                <Flex alignItems={{base:'center',desk:'flex-start'}} w={'100%'}  flexDir={{base: 'column', desk:'row'}} justifyContent={'space-between'} gap={{base:'40px',desk:'80px'}}>
                    <Text   as={'p'} w={{base: '100%',desk:'60%', desk:'60%'}} fontSize={'21px'} fontWeight={600} lineHeight={'31px'} textAlign={'left'} color={'#2E3083'} dangerouslySetInnerHTML={{ __html: t('aboutFranceProjetDesc') }} />
