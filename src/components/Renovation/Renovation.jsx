...
const Renovation = () => {
 ...
 // Внутри функционального компонента
    ...
    return (
        <SectionLayuot props={{display: {base: 'none', xxsm: 'flex'}, id: 'discover'}}>
            ...
            <Flex w={{ base: '80%', lg: '70%' }} justifyContent={'center'} flexWrap={'nowrap'} flexDir={{ base: 'column', lg: 'row' }} >
                <Flex w={{ base: '100%', lg: '50%' }} p={{ sm: '40px ', desk: '34px 40px' }} flexDir={'column'} justifyContent={'space-between'} bgColor={'white'} border={'1px solid #CECECE'} gap={{ sm: '20px', desk: '30px' }} >
                    <Text as={'h3'} fontSize={{ sm: '20px', desk: '26px' }} fontWeight={'700'} color={'#010101'} lineHeight={'31px'} >{t('ourBusiness')}</Text>
                    <Text fontSize={{ sm: '14px', desk: '16px' }} color={'#444444'} lineHeight={'28px'} dangerouslySetInnerHTML={{ __html: t('ourBusinessDesc') }} />
                </Flex>
                <Flex w={{ base: '100%', lg: '50%' }} p={{ sm: '40px ', desk: '34px 40px' }} flexDir={'column'} justifyContent={'space-between'} bgColor={'#2E3083'} gap={{ sm: '20px', desk: '30px' }} >
                    <Text as={'h3'} fontSize={{ sm: '20px', desk: '26px' }} fontWeight={'700'} color={'#FFFFFF'} lineHeight={'31px'} >{t('ourCustom')}</Text>
                    <Text fontSize={{ sm: '14px', desk: '16px' }} color={'#FFFFFF'} lineHeight={'28px'} dangerouslySetInnerHTML={{ __html: t('ourCustomDesc') }} />
                </Flex>
            </Flex>
