                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="ms-auto text-muted">
                                <RouterLink :to="{name: 'blog_created'}" class="btn btn-primary d-sm-inline-block">
                                    Created Blog
                                </RouterLink>
                            </div>
                        </div>
                    ...
                    <table class="table card-table table-vcenter text-nowrap datatable">
                        ...
                        <tr v-for="item in newsItem" :data-category-id="item.id">
                            ...
                            <td class="text-nowrap text-muted">
                                ...
                                <RouterLink :to="{name: 'blog_edit', params: { id: item.id}}"
...
export default {
    ...
    methods: {
        ...
        getNews(pageNum){
            BlogsService.get(pageNum).then((resp) => {
        ...
        status(event) {
            ...
            BlogsService.setStatus(formData({
                id: itemId,
                status: statusId,
            })).then((resp) => {
