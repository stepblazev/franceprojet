                                        ...
                                        <div v-for="(item, index) in langItem" class="row tab-pane"
                                            ...
                                            <div class="col-xl-12">
                                                <div class="row">
                                                    ...
                                                    <div class="mb-3">
                                                        <label class="form-label">Text {{ item.value.toUpperCase() }}</label>
                                                        <editor
...
export default {
    ...
    mounted() {
        ...
        UtilitiesService.getData().then((res) => {
            ...
            BlogsService.getBy(this.$route.params.id).then((res) => {
    ...
    methods: {
        ...
        editArticles(data) {
            ...
            BlogsService.edit(params).then((res) => {
                alert('BLog updated', 'success')

                setTimeout(() => {
                    this.$router.push("/admin/blog/main");
                }, 2000);
            }).catch((error) => {
