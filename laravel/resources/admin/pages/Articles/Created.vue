                ...
                <div class="col-12">
                    ...
                    <form class="card card-md" @submit.prevent="createdArticles">
                        <div class="card-header">
                            <h4 class="card-title">Créer de nouvelles</h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-xl-6">
                                            ...
                                            <div class="col-xl-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-xl-12">
                                                        <div class="mb-3">
                                                            <label class="form-label required">Nom nouvelles
...
export default {
    ...
    data() {
        return {
            headerProps: [{
                breadcrumb: true,
                textBreadcrumb: 'Créer de nouvelles nouvelles',
    ...
    methods: {
        ...
        createdArticles(data) {
            ...
            ArticlesService.createdArticles(params).then((res) => {
                alert('Nouvelles créées', 'success')
