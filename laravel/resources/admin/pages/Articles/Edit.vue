                ...
                <div class="col-12">
                    ...
                    <form class="card card-md" @submit.prevent="editArticles">
                            ...
                            <div class="row">
                                            ...
                                            <div class="col-xl-12">
                                                <div class="row">
                                                    <div class="col-md-6 col-xl-12">
                                                        <div class="mb-3">
                                                            <label class="form-label required">Nom de l'article
                                                    ...
                                                    <div class="mb-3">
                                                        <label class="form-label">Texte {{ item.value.toUpperCase() }}</label>
                                                        <editor
                                ...
                                <div class="col-xl-6">
                                    <div class="mb-3">
                                        ...
                                        <div>
                                            <select name="status" class="form-select"
                                                ...
                                                <option value="0" :selected="this.content.status">Aucun actif
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3" v-bind:class="{ 'd-none' : uploadImage === false}">
                                        <label class="form-label">Photo sélectionnée</label>
                                        <div class="row g-2">
                        ...
                        <div class="card-footer text-end">
                            <div class="d-flex">
                                <button class="btn btn-primary ms-auto">Sauvegarder</button>
                            </div>
                        </div>
                    </form>
                </div>
...
export default {
    ...
    data() {
        return {
            headerProps: [{
                breadcrumb: true,
                textBreadcrumb: 'Modifier l\'article',
    ...
    methods: {
        ...
        editArticles(data) {
            ...
            ArticlesService.editArticles(params).then((res) => {
                alert('Nouvelles mises à jour', 'success')
